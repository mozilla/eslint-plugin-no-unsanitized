        ...
        return {
            ...
            CallExpression: function (node) {
                ...
                case "Super":
                    break;
                default:
                    context.report(node, "Error in no-unsafe-innerhtml: Unexpected Callee. Please report this function call to the developers at https://github.com/jonathanKingston/eslint-plugin-no-unescaped/issues/new?title=Unsupported+Callee+for+CallExpression");
                }
            }
        };
