/* global module */
/**
 * @fileoverview ESLint rule to disallow unsanitized DOM access
...
module.exports = {
    ...
    create(context) {
        ...
        function reportUnsupported(node, reason, errorTitle) {
            ...
            context.report(node, `Error in no-unsanitized: ${reason}. Please report a minimal code snippet to the developers at ${bugPath}`);
        }
